...
# val_sentence, _, _ = data.formated_dataset(val_sentence, batch=True, batch_size=len(val_sentence))
val_sentence, _, _ = data.formated_dataset(val_sentence[:20], batch=True, batch_size=20)
...
nerModel.train(inputs=train_sentences, validation_data=val_sentence)
